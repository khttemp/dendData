...
void __fastcall FUN_0041e3d0(undefined4 param_1,undefined4 param_2)

{
  ...
  case 0x152:
    ...
    uVar4 = puVar1[1];
    uVar12 = *puVar1;
    uVar8 = FUN_004aa600(param_1,param_2);
    FUN_0040aa00(unaff_EDI + 10,(int)uVar8,uVar12,uVar4,uVar5,fVar9);
    return;
  case 0x153:
    fVar9 = (float)(*(undefined4 **)(in_EAX + 4))[2];
    uVar5 = **(undefined4 **)(in_EAX + 4);
    FUN_004aa600(param_1,param_2);
    FUN_0041dcb0(unaff_EDI + 10,uVar5,fVar9);
    return;
  case 0x154:
    uVar8 = FUN_004aa600(*(undefined4 *)(in_EAX + 4),param_2);
  ...
  case 0x156:
    ...
    (**(code **)(DAT_004b7570 + 0x18))();
    uVar5 = *(undefined4 *)(*(int *)(in_EAX + 4) + 0xc);
    uVar4 = *(undefined4 *)(*(int *)(in_EAX + 4) + 8);
    (**(code **)(DAT_004b7570 + 0x18))();
    fVar7 = (float10)(**(code **)(DAT_004b7570 + 0x18))
                               (*(undefined4 *)(*(int *)(in_EAX + 4) + 0x14),
                                *(undefined4 *)(*(int *)(in_EAX + 4) + 0x18));
    fVar9 = (float)fVar7;
    FUN_004aa600(extraout_ECX,extraout_EDX);
    FUN_0040ebb0(unaff_EDI + 0x52,uVar5,uVar4,fVar9);
  ...
  case 0x157:
    ...
    uVar8 = FUN_004aa600(extraout_ECX_00,extraout_EDX_00);
    FUN_0040aa00(unaff_EDI + 10,(int)uVar8,uVar4,uVar5,fVar9,fVar10);
    return;
  case 0x158:
    fVar9 = **(float **)(in_EAX + 4);
    fVar10 = (*(float **)(in_EAX + 4))[1];
    ...
    fVar7 = (float10)(**(code **)(DAT_004b7570 + 0x18))();
    fVar9 = (float)fVar7;
    FUN_004aa600(*(undefined4 *)(in_EAX + 4),extraout_EDX_01);
    FUN_0041dcb0(unaff_EDI + 10,uVar5,fVar9);
    return;
  case 0x159:
    fVar9 = **(float **)(in_EAX + 4);
    ...
    fVar7 = (float10)(**(code **)(DAT_004b7570 + 0x18))();
    fVar9 = (float)fVar7;
    FUN_004aa600(*(undefined4 *)(in_EAX + 4),extraout_EDX_02);
    FUN_00401350(unaff_EDI + 3,uVar5,fVar9);
    return;
  default:
    MessageBoxA((HWND)0x0,&DAT_004ae168,"ERROR",0x10);
    printf(&DAT_004ae168);
    printf("ASSERT : %4d, %s\n");
  ...
  case 0x15b:
    ...
    fVar11 = fVar9;
    fVar13 = fVar9;
    uVar8 = FUN_004aa600(extraout_ECX_01,extraout_EDX_03);
    FUN_0040aa00(unaff_EDI + 10,(int)uVar8,fVar9,fVar11,fVar13,fVar10);
    return;
  case 0x15c:
...
LAB_0041e9e7:
    uVar8 = FUN_004aa600(uVar4,uVar5);
    FUN_0040aa00(unaff_EDI + 0x3d,(int)uVar8,in_stack_ffffffd4,in_stack_ffffffd8,in_stack_ffffffdc,
                 fVar9);
    return;
  }
