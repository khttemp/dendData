...
const CMD = {
    ...
    "CharChk_and_Tx": {
        ...
        "description": "【モデルバイナリ】" + newLine
                    ...
                    + "引数２：開放の場合、画像サイズ情報のインデックス" + newLine
                    + "引数３：未開放の場合、画像サイズ情報のインデックス",
        "LS_bin": [
            "CHARSEL.BIN"
        ]
    },
    ...
    "ClearStory_and_Tx": {
        ...
        "description": "【モデルバイナリ】" + newLine
                    ...
                    + "引数１：ストーリーインデックス" + newLine
                    + "引数２：クリアの場合、画像サイズ情報のインデックス" + newLine
                    + "引数３：クリアではない場合、画像サイズ情報のインデックス",
        "LS_bin": [
            "STORYSEL.BIN"
        ]
    },
    ...
    "GET_KEY": {
        ...
        "description": "【SS】" + newLine
                    ...
                    + "指定時間内に、上記の条件ではない場合、引数４のFROMへ飛ぶ" + newLine
                    + "引数１：キー条件" + newLine
                    + "引数２：指定時間（フレーム）" + newLine
                    + "引数３：FROM数字" + newLine
                    + "引数４：FROM数字"
    ...
    "FOG_POW": {
        ...
        "description": "【SS】" + newLine
                    ...
                    + "ただし、引数１が0より小さい場合、0.08で調整される" + newLine
                    + "ブラインドアタックしてない状況では効果はない" + newLine
                    + "引数１：fogの程度" + newLine
                    + "引数２：変化時間" + newLine
                    + "引数３：スクリーン番号【SSで引数で渡す場合】",
        "SS_comic": [
